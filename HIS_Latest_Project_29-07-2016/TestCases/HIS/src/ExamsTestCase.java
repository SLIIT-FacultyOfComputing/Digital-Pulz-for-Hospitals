...
public class ExamsTestCase extends BaseTestCase{
	 ...
	 */
	@Test(groups = "his.opd.test", dependsOnMethods = { "addExamTestCase", "getExamsbyVisitIdTestCase" })
	public void updateExamTestCase() throws IOException, JSONException {

		// Get JSON Request body to send exam update Request
	 ...
	 * @throws JSONException 
	 */
	@Test(groups = "his.opd.test", dependsOnMethods = { "addExamTestCase"})
	...
	/**
	 * This test case is for get exams by exam ID
	 * 
	 * @throws IOException
	 * @throws JSONException 
	 */
	@Test(groups = "his.opd.test", dependsOnMethods = { "addExamTestCase", "getExamsbyVisitIdTestCase", "updateExamTestCase"})
