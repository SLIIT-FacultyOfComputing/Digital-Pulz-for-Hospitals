...
public class HinResources {
	...
	final static Logger log = Logger.getLogger(HinResources.class);
	/**
	...
	{
		log.info("Entering the serial Number For Hin method");
		...
		log.info("new Patient HIN = " + PatientNewHIN);
	...
	public String generateChekDigit() throws Exception{
		...
		log.info("Entering the generate CheckDigit method");
		int checkDigit;
