 <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="<?php echo base_url(); ?>css/img/user2-160x160.png" class="img-circle" alt="User Image" />
            </div>
        ...
        <?php
                            ...
                            ?>
<!--           <li ><a href="<?php echo base_url(); ?>index.php/History/patientHistoryC/index"><i class="text-primary"></i>Patient History</a></li>
                        
           <li ><a href="<?php echo base_url(); ?>index.php/History/PatientHistoryDetailsC/index"><i class="text-primary"></i>Patient Details</a></li>-->

           <li ><a href="<?php echo base_url(); ?>index.php/History/PatientArchiveC/index"><i class="text-primary"></i>Patient Archived Details</a></li>
