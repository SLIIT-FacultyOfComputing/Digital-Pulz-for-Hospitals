								...
								<div class="col-xs-12 col-sm-8">
									...
									<table>
										...
										<tr>
											...
											<td style="padding-left: 10px ">
											<?php echo $visit[0]->visitComplaint; ?>
											</td>
										</tr>
									</table>
								</div>
		...
		<div class='box-body'>
			...
			<div class="nav-tabs-custom">
				...
				<ul class="nav nav-tabs">
					...
					<li><a href="#tab_5" data-toggle="tab">Treatments</a></li>
					<li><a href="#tab_6" data-toggle="tab">Injections</a></li>
								...
								<table class="table table-bordered table-striped table-hover"
									...
									<tbody>
										...
										<td><?php echo $visit[0]->visitType; ?></td>
											...
											<td> <?php date_default_timezone_set('Asia/Colombo'); echo date("Y-m-d h:i:s A", $visit[0]->visitDate / 1000); ?> </td>
								...
								<table class="table table-bordered table-striped table-hover"
									...
									<tbody>
									     <?php $i=0; if ($presitems != NULL) foreach ($presitems as $item) { ?>
											...
											<td><?php date_default_timezone_set('Asia/Colombo'); echo date('Y-m-d h:i:s A', $visit[0]->prescriptions[0]->prescriptionDate / 1000); ?></td>
								...
								<table class="table table-bordered table-striped table-hover"
									...
									<tbody>
									     <?php $i=0; if ($laborders != NULL) foreach ($laborders as $row) { ?>
                                                <tr>
											<td><?php echo ++$i; ?></td>
											<td id="tdtest"><?php echo $row->ftest_ID->test_Name; ?>
								...
								<table class="table table-bordered table-striped table-hover"
									...
									<tbody>
									     <?php $i=0; if ($exams != NULL) foreach ($exams as $row) { ?>
											...
											<td><?php date_default_timezone_set('Asia/Colombo'); echo date('Y-m-d h:i:s A', $row['examDate'] / 1000); ?> </td>

											<td><?php echo $row['examWeight']; ?></td>
											<td><?php echo $row['examHeight']; ?></td>
											<td><?php echo $row['exambmi']; ?></td>
					...
					<div class="box">
							<div class="box-body">
								<table class="table table-bordered table-striped table-hover"
									...
									<tbody>
									     <?php $i=0; if ($treatment != NULL) foreach ($treatment as $row) { ?>
                                                <tr>
											<td><?php echo ++$i; ?></td>

											<td><?php  date_default_timezone_set('Asia/Colombo'); echo date('Y-m-d h:i:s A', $row['createDate'] / 1000); ?> </td>
											<td><?php echo $row['treatments']['treatment']; ?></td>
					...
					<div class="box">
							<div class="box-body">
								<table class="table table-bordered table-striped table-hover"
									...
									<tbody>
									     <?php $i=0; if ($injection != NULL) foreach ($injection as $row) { ?>
                                                <tr>
											<td><?php echo ++$i; ?></td>

											<td><?php  date_default_timezone_set('Asia/Colombo'); echo date('Y-m-d h:i:s A', $row['createDate'] / 1000); ?> </td>
											<td><?php echo $row['injectionId']['name']; ?></td>
											<td><?php echo $row['remarks']; ?></td>
											<td><?php echo $row['status']; ?></td>
