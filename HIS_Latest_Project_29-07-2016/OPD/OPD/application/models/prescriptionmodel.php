...
class PrescriptionModel {
	...
	public function addPrescription()
	{
		...
		$patientJSON   = json_encode($this->drug_list); 
               ...
               // die();
		$service_url =  SERVICE_BASE_URL."Prescription/addPrescription/".$this->pid."/".$this->visitid."/".$this->userid."/".$this->presid;
	...
	{
		$service_url = SERVICE_BASE_URL."PharmacyServices/drugMainStock";
		$curl_request = new ServiceCaller();
		$response = $curl_request->curl_GET_Request($service_url);
		return $response;
	}
	...
	{
		$service_url = SERVICE_BASE_URL."DrugServices/getPharmFrequency";
		$curl_request = new ServiceCaller();
		$response = $curl_request->curl_GET_Request($service_url);
		return $response;
	}
	...
	{
		$service_url = SERVICE_BASE_URL."DrugServices/getDosages";
		$curl_request = new ServiceCaller();
		$response = $curl_request->curl_GET_Request($service_url);
		return $response;
	}
	public function getLastPrescriptionId()
	{
		$service_url = SERVICE_BASE_URL."Prescription/getLastPrescriptionId";
		$curl_request = new ServiceCaller();
		$response = $curl_request->curl_GET_Request($service_url);
		return $response;
	}
