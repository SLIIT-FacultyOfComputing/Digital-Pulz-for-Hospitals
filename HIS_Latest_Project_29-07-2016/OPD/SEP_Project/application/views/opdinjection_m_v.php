...
<div id="tablecont" style="border:RGB(245,245,245) 2px solid; width: 90%; height:530px;overflow-y:scroll" >
    <table class="table table-bordered table-striped table-hover"  id="testp" >
        <thead>
            ...
            <tr>
                ...
                <td>
                <select id="txtsrchinjection"  class="tblsearch" name="Injection" style="width: 100%; text-align: center;">
                        <option  selected  value="Any">Any</option>
                        <?php foreach ( $injection as $row ) { ?>
                        <option
                          itemid=<?php echo $row->name; ?>><?php echo $row->name; ?>
                        </option> 
        ...
        <div id="tbody">
            <?php foreach ($opdinjection as $row) { ?>
                ...
                <tr style="font-size:13px;cursor:pointer;" onClick="rowClick(event)" >
                    ...
                    <td id="tdinjection"><?php echo $row->injectionId->name; ?></td>
                    <td id="tdstatus"><?php echo $row->status; ?></td>
                    <td id="tdremarks" hidden><?php echo $row->remarks; ?></td>
					<td id="tdid" hidden><?php echo $row->opdInjectionId; ?></td>
			<?php } ?>
  ...
  <div class="modal-dialog modal-md">
	<?php    
      	echo form_open('injection_c/update', array('name' => 'myform','id' => 'myform'));
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Injection</h4>
        <input  type="text" id="inputopdInjectionId" name="inputopdInjectionId" placeholder="" hidden>
      </div>
      <div class="modal-body">
         <div class="row">
         	...
         	<div class="col-md-5">
         		<input style="width:100%;"  type="text" id="inputInjection" name="inputInjection" placeholder="" disabled>
         	</div>
         </div>
         <br/>
         <div class="row">
