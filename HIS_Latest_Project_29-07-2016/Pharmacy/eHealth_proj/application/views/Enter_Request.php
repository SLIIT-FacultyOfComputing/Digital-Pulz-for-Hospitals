...
<section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
  <section class="content" id="selectdrug">
          <!-- Default box -->
          <div class="box">
            <div class="box-header with-border">
...
<section class="content" id="box2" style="visibility: hidden;">
          <!-- Default box -->
          <div class="box">
            <div class="box-header with-border">
            ...
            <br>       
            <input type=submit class="btn btn-primary" value='Add Request' onclick="createRequestOptiontableRC()" />                
            <br>                
            <p id="drugspaceRC"></p>
            </div><!-- /.box-body -->
          </div><!-- /.box -->
...
<section class="content" id="post_request_tbl_RC" style="visibility: hidden;">
          <!-- Default box -->
          <div class="box">
            <div class="box-header with-border">
