...
require_once('/opt/lampp/htdocs/eHealth_proj/application/views/tcpdf/config/tcpdf_config.php');
require_once('/opt/lampp/htdocs/eHealth_proj/application/views/tcpdf/tcpdf.php');
