...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('Contents/cssnew/jquery.dataTables.css'); ?>" media="all"/>
       ...
       <!-- // <script type="text/javascript" src="<?php echo base_url() . 'Scripts/JS/'; ?>jquery.min.js"></script> -->
        ...
        <script type="text/javascript" src="<?php echo base_url() . 'Scripts/JS/'; ?>bootstrap-combobox.js"></script>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="<?php echo base_url("index.php/Prescribe_Controller")?>" class="logo"><img src="<?php echo base_url('public/assets/img/logof.png'); ?>" height="50" width="200"/></a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url("/Prescribe_Controller"); ?>">
                                <i class="fa fa-dashboard"></i> <span>Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo site_url("/Request_Controller/addRequestDrug"); ?> ">
                                <i class="fa fa-stethoscope"></i> <span>Send Requests</span>
                            </a>
                        </li>
                    </ul>
                </section>
...
<!--        <script type="text/javascript" src="--><?php //echo base_url() . 'Scripts/JS/'; ?><!--jquery.js"></script>-->
       ...
       <!-- <script type="text/javascript" src="<?php /*echo base_url('Bootstrap/js/jquery-1.11.1.min.js'); */?>"></script>
        <script type="text/javascript" src="<?php /*echo base_url('Scripts/JS/jquery-1.9.1.min.js'); */?>"></script>-->
        <!-- Bootstrap 3.3.2 JS -->
