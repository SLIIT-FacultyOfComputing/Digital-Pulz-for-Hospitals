          ...
          <!-- Default box -->
                ...
                <p>
                    <form id="frmDispense" name="frmDispense">
                        <div> <h3>Patient HIN :</h3>  <input type="text" id="pation" name="pation"/>
                            ...
                            <div id="itembDiv" style="width:100%">
                                ...
                                <div >
                                    <table  cellpadding="0" cellspacing="0" border="0" id="itemDataTable"
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="4%" class="head0">Drug ID</th>
                                                ...
                                                <th width="11%" class="head0">Unit Price</th>
                                ...
                                <hr/>
                                <br/>
                                <div><h4><input type="button" class="btn btn-warning" id="dispense" name="dispense" value="Dispense"/>
                               <input type="button" class="btn btn-primary" id="bill" name="bill" value="Bill"/>
                                </h4></div>
                                <div><h4>
                                <input class="form-control" type="button" id="back" name="back" value="<< Back "/></h4></div>
