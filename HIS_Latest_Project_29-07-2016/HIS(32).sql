...
--
-- Host: localhost
-- Generation Time: Jul 27, 2016 at 09:23 AM
...
(1, 'TN', 'qqqqqqqqqqqq', '2016-07-25 08:06:59', '2016-07-25 08:06:59', 1, 1, NULL, 1),
...
(4, 11, '2016-07-25 13:33:15', 3, 1, 'In', ''),
(5, 8, '2016-07-25 13:41:55', 3, 1, 'Waiting', ''),
(1, 8, '2016-07-27 12:03:33', 3, 1, 'Waiting', 'wqewqeq'),
(2, 14, '2016-07-27 12:03:55', 3, 1, 'Waiting', '123'),
(3, 4, '2016-07-27 12:05:13', 3, 1, 'In', 'sdfs');
...
CREATE TABLE IF NOT EXISTS `ward_admission` (
  ...
  `discharge_immr` varchar(200) NOT NULL,
...
INSERT INTO `ward_admission` (`bht_no`, `patient_id`, `bed_no`, `ward_no`, `daily_no`, `monthly_no`, `yearly_no`, `doctor_id`, `admit_date_time`, `patient_complain`, `previous_history`, `discharge_type`, `remark`, `admission_unit`, `created_user`, `created_date_time`, `last_updated_user`, `last_updated_date_time`, `status`, `sign`, `outcomes`, `dischargediagnosis`, `referredto`, `discharge_immr`, `icd_code`) VALUES
...
--
ALTER TABLE `lab_subtestfields`
  MODIFY `sub_test_field_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `lab_testfieldsrange`
  MODIFY `range_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=45;
--
...
--
ALTER TABLE `opd_patient`
  MODIFY `patient_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=71;
--
